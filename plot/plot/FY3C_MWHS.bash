...
#for channal two
declare -i -x VALUERANGE_CH2=12
declare -i -x VALUESPAN_CH2=1
declare -i -x VALUESUB_CH2=6
declare -i -x VALUEADD_CH2=0

#for channal three
declare -i -x VALUERANGE_CH3=12
declare -i -x VALUESPAN_CH3=1
declare -i -x VALUESUB_CH3=6
declare -i -x VALUEADD_CH3=0

#for channal four
declare -i -x VALUERANGE_CH4=12
declare -i -x VALUESPAN_CH4=1
declare -i -x VALUESUB_CH4=6
...
#for channal seven
declare -i -x VALUERANGE_CH7=24
declare -i -x VALUESPAN_CH7=2
declare -i -x VALUESUB_CH7=12
declare -i -x VALUEADD_CH7=0

#for channal eight
declare -i -x VALUERANGE_CH8=24
declare -i -x VALUESPAN_CH8=2
declare -i -x VALUESUB_CH8=12
declare -i -x VALUEADD_CH8=0

#for channal nine
declare -i -x VALUERANGE_CH9=36
declare -i -x VALUESPAN_CH9=3
declare -i -x VALUESUB_CH9=18
declare -i -x VALUEADD_CH9=0

#for channal ten
declare -i -x VALUERANGE_CH10=36
declare -i -x VALUESPAN_CH10=3
declare -i -x VALUESUB_CH10=18
...
declare -i -x VALUERANGE_CH14=12
declare -i -x VALUESPAN_CH14=1
declare -i -x VALUESUB_CH14=6
declare -i -x VALUEADD_CH14=0

#for channal fifteem
declare -i -x VALUERANGE_CH15=24
declare -i -x VALUESPAN_CH15=2
declare -i -x VALUESUB_CH15=12
declare -i -x VALUEADD_CH15=0
