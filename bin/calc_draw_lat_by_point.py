...
Usage:
    calc_draw_lat_by_point.py --sat=fy3c --ins=mwts --nwp=t639 --lat_span=5
...
def draw_one_channel_crtm(channel):
    ...
    cmd = conf.ncl + ' ' + " 'sat=\"" \
        ...
        + " 'file_in=\"" + tmphdf + "\"' " \
        + " 'file_out=\"" + tmp_png + "\"' " \
        + " 'file_title=\"" + png_title + "\"' "  + " /home/fymonitor/MONITORFY3C/py2/plot/scan_point_time_crtm.ncl"\
        + ' > ' + tmpfile + '.log' + ' 2>&1'
    print cmd
...
def draw_one_channel_rttov(channel):
    ...
    cmd = conf.ncl + ' ' + " 'sat=\"" \
        ...
        + " 'file_in=\"" + tmphdf + "\"' " \
        + " 'file_out=\"" + tmp_png + "\"' " \
        + " 'file_title=\"" + png_title + "\"' "  + " /home/fymonitor/MONITORFY3C/py2/plot/scan_point_time_rttov.ncl"\
        + ' > ' + tmpfile + '.log' + ' 2>&1'
    print cmd
    (status, output) = commands.getstatusoutput(cmd)
    common.debug(my_log, log_tag, str(status) + '`' + cmd + '`' + output)
