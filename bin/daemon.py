...
def main():
    ...
    if len(pid_list)==1:
        common.debug(my_log, log_tag, 'I have find the process!!!')
        ...
        common.debug(my_log, log_tag, 'I am not find the process!!!!')
        msg = target_name + ': ' + target_program + ' [ ' + target_pid + \
